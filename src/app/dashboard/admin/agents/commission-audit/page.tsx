...
function agentTypeLabel(agent: FlaggedAgent): string {
  ...
  if (agent.teamRole === 'member') {
    ...
    return `Team Member${group ? ` (${group})` : ''}`;
  }
    ...
    <main className="p-6 max-w-5xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          Active agents who are missing a saved commission structure. Open each profile and click
          Save to automatically populate the correct tiers.
        </p>
      </div>
