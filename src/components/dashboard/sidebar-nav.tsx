...
const agentMenuItems = [
  ...
  { href: '/dashboard/hub', label: 'Keaty Hub', icon: Newspaper },
...
const adminMenuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/admin/hub', label: 'Hub Management', icon: Newspaper },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/admin/transaction-integrity', label: 'Transaction Inspector', icon: FileSearch },
