...
export const defaultAssumptions: PlanAssumptions = {
  conversionRates: {
    ...
    appointmentSetToHeld: 0.65, // 65% of appointments set are held
    appointmentHeldToContract: 0.5, // 50% of appointments held become contracts
    contractToClosing: 0.85, // 85% of contracts close
  },
  avgCommission: 3000,
